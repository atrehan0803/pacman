...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for dis in livingGhostPositionDistributions:
            positions.append(dis.argMax())

        closestPos = min(positions, key=lambda ghost: dist(pacmanPosition, ghost))
        greedy = min(legal, key=lambda action: dist(Actions.getSuccessor(pacmanPosition, action), closestPos))
        return greedy
